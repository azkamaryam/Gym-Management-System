        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <?php if (!isset($_SESSION['user_id'])): ?>
                    <a href="http://localhost/Gym%20Management%20System/user/login.php" class="btn btn-primary">Login</a>
                <?php else: ?>
                    <form class="d-flex">
            ...
            <div class="form-container bg-dark">
                ...
                <form action="processes/process_signup.php" method="post">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="username" name="username" style="width: 400px;" placeholder="Username" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="phone" name="phone" style="width: 400px;" placeholder="Only for instructors">
                    </div>
                    <div class="mb-3">
                        <label for="role" class="form-label text-light">Role</label>
                        <input type="text" class="form-control" id="role" name="role" style="width: 400px;" placeholder="(Member, Instructor)" required>
                    </div>
                    <div class="mb-3">
                        <label for="speciality" class="form-label text-light">Speciality</label>
                        <input type="text" class="form-control" id="speciality" name="speciality" style="width: 400px;" placeholder="Only for Instructors">
                    </div>
