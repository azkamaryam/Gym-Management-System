...
<head>
    ...
    <title>Instructors Login - Athelete's Fitness</title>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <?php if (!isset($_SESSION['user_id'])): ?>
                    <a href="http://localhost/Gym%20Management%20System/instructors/profile/signup.php" class="btn btn-primary">Sign Up</a>
                <?php else: ?>
    ...
    <div class="container-fluid vh-100 d-flex">
        ...
        <div class="col-md-7 d-flex align-items-center justify-content-center">
            <div class="form-container bg-dark">
                <h2 class="text-light">Instructor Login</h2>
                <form action="processes/process_login.php" method="post">
                    <div class="mb-3">
                        <label for="username" class="form-label text-light">Username</label>
                        <input type="text" class="form-control" id="full_name" name="full_name" style="width: 400px;" required>
                    </div>
                    <div class="mb-3">
